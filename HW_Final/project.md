...
На этом этапе пришлось отвлечься на решение проблем, описанные в разделе "Возможные ошибки".
...
**Испытания режима switchower успешно проведены. Каждая нода побывала лидером и репликой, умеет передавать и принимать изменения**
